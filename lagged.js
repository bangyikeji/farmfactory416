console.log("LaggedAPI Revenue Share: v1.2.5");
...
!function () {
  ...
  try {
    ...
    if (!isApprovedDomain) {
      ...
      if (!isDevMode) {
        ...
        console.log("cover game, open on click: ");
  ...
  var E, f = function (e, t) {
    ...
    e && !0 === e.success ? !0 === e.data.show && N(e.data.achdata, e.user) : (console.log("Error: Achievement did not save!"),
      console.log(e),
      a.success = !1,
      a.errormsg = "Error: Achievement did not save!"),
      t && t(a)
  }, C = function (e, t) {
    var a = {
      success: !0
    ...
    n.id = "achievementPopWrap",
      ...
      ;
    var r = "Achievement Saved";
    1 < e.acount && (r = e.acount + " Achievements Saved");
    var d = document.createElement("div");
